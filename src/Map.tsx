...
function calculateGradientExpression(
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    const speed = point?.properties?.["speed (km/h)"]
      ? parseInt(point?.properties?.["speed (km/h)"], 10)
      : undefined;
    if (!speed) {
